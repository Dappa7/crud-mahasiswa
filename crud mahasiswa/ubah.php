                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select w-50" id="jurusan" name="jurusan">
                            ...
                            <option value="Teknik Industri" <?php if ($siswa['jurusan'] == 'Teknik Industri') { ?> selected='' <?php } ?>>Teknik Industri</option>
                            <option value="Manajemen" <?php if ($siswa['jurusan'] == 'Manajemen') { ?> selected='' <?php } ?>>Manajemen</option>
                            <option value="Akuntansi" <?php if ($siswa['jurusan'] == 'Akuntansi') { ?> selected='' <?php } ?>>Akuntansi</option>
                        </select>
                    </div>
                    <div class="mb-3">
