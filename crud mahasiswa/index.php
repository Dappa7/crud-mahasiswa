...
<head>
    ...
    <title>Sistem Distribusi | CRUD</title>
</head>
    ...
    <div class="container-fluid">
        <div class="row bg-dark text-white">
            <div class="col-md-6 my-2" id="about">
                ...
                <p><p>Data mahasiswa merupakan informasi pribadi mengenai mahasiswa suatu perguruan tinggi yang dapat digunakan untuk berbagai tujuan, seperti mengetahui nama, jenis kelamin, umur, dan program studi.</p></p>
            </div>
